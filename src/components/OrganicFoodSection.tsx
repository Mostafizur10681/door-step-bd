  ...
  return (
    <div className="w-full max-w-[1680px] mx-auto px-4 sm:px-8 py-6">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 border border-slate-200/80 rounded-2xl overflow-hidden bg-white shadow-xs">
              ...
              >
                ...
                <div className="absolute top-2 right-2 z-20 flex flex-col gap-1.5 items-center">
                  ...
                  <button
                    ...
                    className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white/95 border border-slate-200/90 text-slate-600 hover:bg-[#002B49] hover:text-white hover:border-[#002B49] hover:scale-105 flex items-center justify-center shadow-xs transition-all duration-200 cursor-pointer sm:opacity-0 sm:group-hover/org:opacity-100 opacity-90"
                  >
        ...
        <div className="lg:col-span-4 bg-[#002B49] p-6 sm:p-8 lg:p-10 flex flex-col justify-center text-center relative overflow-hidden order-1 lg:order-2">
          ...
          <div className="relative z-10 space-y-4">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white leading-tight tracking-tight">
              Exclusive Deals <br />
              & Big Discounts <br />
              <span className="text-[#FF6600]">On Top Products</span>
            </h2>
            ...
            <div className="pt-2">
              <Link
                href="/discount"
                className="inline-flex items-center gap-1.5 px-6 py-2.5 bg-[#FF6600] hover:bg-[#E65A00] text-white font-black text-xs sm:text-sm rounded-full shadow-md transition-all duration-300 group/btn cursor-pointer active:scale-95"
              >
                <span>See More</span>
