...
export default function BlogDetailPage() {
  ...
  if (!post) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center py-20 px-4 text-center space-y-4">
        ...
        <Link
          href="/blog"
          className="bg-[#122B5A] text-white px-6 py-2.5 rounded-xl font-bold text-xs hover:bg-[#FFB800] transition inline-flex items-center gap-2"
        >
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans pb-20 space-y-10">
      ...
      <div className="bg-gradient-to-r from-[#122B5A] via-[#0A3299] to-[#E50914] text-white py-10 sm:py-14">
      ...
      <div className="max-w-4xl mx-auto px-4 grid grid-cols-1 gap-10">
        ...
        <article className="bg-white rounded-3xl border border-slate-200/90 overflow-hidden shadow-sm p-6 sm:p-10 space-y-8">
          ...
          {/* HTML Body */}
          <div
            className="prose prose-slate max-w-none prose-headings:font-black prose-headings:text-slate-900 prose-p:text-slate-600 prose-p:leading-relaxed prose-p:text-sm sm:prose-p:text-base prose-a:text-[#122B5A] prose-img:rounded-2xl"
          ...
          <div className="pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-bold text-[#122B5A] hover:text-[#122B5A] transition bg-blue-50 px-4 py-2 rounded-xl"
            >
              ...
              {relatedPosts.map((rel) => (
                ...
                >
                  <div className="space-y-3">
                    ...
                    <h4 className="font-bold text-slate-900 text-sm line-clamp-2 hover:text-[#122B5A] transition">
                  ...
                  <div className="pt-3 flex items-center justify-between text-xs text-slate-400 mt-2">
                    ...
                    <Link
                      href={`/blog/${rel.slug}`}
                      className="font-bold text-[#122B5A] hover:text-[#122B5A]"
                    >
                      Read &rarr;
                    </Link>
                  </div>
