      ...
      <div className="max-w-6xl mx-auto px-4 space-y-12">
        ...
        <div className="space-y-6">
          <div className="text-center space-y-1">
            <h2 className="text-2xl font-black text-[#122B5A]">How Returns Work</h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-2">
                    <div className="w-12 h-12 rounded-2xl bg-[#122B5A]/10 text-[#122B5A] flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-md space-y-6">
            <div className="border-b border-slate-100 pb-4 space-y-1">
              <h3 className="text-xl font-black text-[#122B5A]">Submit Return Request</h3>
            ...
            {submitted ? (
              <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-8 text-center space-y-3">
                ...
                <button
                  ...
                  className="inline-block text-xs font-bold text-[#122B5A] underline pt-2 cursor-pointer"
                >
              ...
              <form onSubmit={handleSubmitReturn} className="space-y-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs text-slate-800 focus:outline-none focus:bg-white focus:ring-2 focus:ring-[#122B5A]/30 font-mono"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs text-slate-800 focus:outline-none focus:bg-white focus:ring-2 focus:ring-[#122B5A]/30 font-medium"
                  >
                ...
                <button
                  type="submit"
                  className="w-full bg-[#122B5A] hover:bg-[#0B1B38] text-white font-bold text-xs py-3 px-6 rounded-xl shadow-md transition flex items-center justify-center gap-2"
                >
        ...
        {/* Need Help Banner */}
        <div className="bg-gradient-to-r from-slate-900 to-[#122B5A] rounded-3xl p-6 sm:p-8 text-white flex flex-col sm:flex-row items-center justify-between gap-4 shadow-lg">
