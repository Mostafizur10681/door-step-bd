    ...
    <div className="bg-slate-50 min-h-screen font-sans py-10 pb-20">
      <div className="max-w-[1500px] mx-auto px-4 space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-3 text-xs text-slate-600 flex items-center gap-1 shadow-xs">
          ...
          <button type="button" className="text-[#122B5A] font-bold underline hover:text-[#122B5A] cursor-pointer">
        ...
        {cart.length === 0 ? (
          <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center space-y-4">
            ...
            <Link
              href="/"
              className="inline-block bg-[#FFB800] text-[#122B5A] font-bold text-xs px-6 py-3 rounded-full shadow transition hover:bg-[#E6A600]"
            >
              Return to Shop
            </Link>
          </div>
          ...
          <form onSubmit={handlePlaceOrder} className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 bg-white border border-slate-200 rounded-lg p-6 sm:p-10 shadow-sm space-y-6">
              ...
              <h2 className="text-2xl font-bold text-[#122B5A] border-b border-slate-100 pb-4">
                Billing details
              </h2>
              ...
              <div className="space-y-4 text-xs text-slate-700">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-slate-300 rounded-md px-3 py-2.5 text-xs text-slate-800 focus:outline-none focus:border-[#122B5A] focus:ring-1 focus:ring-[#122B5A]"
                  />
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-100/70 border border-slate-300 rounded-md px-3 py-2.5 text-xs text-slate-800 focus:outline-none focus:border-[#122B5A]"
                  >
                ...
                <div className="pt-3 border-t border-slate-100">
                  <label className="inline-flex items-center gap-2 cursor-pointer font-bold text-slate-800">
                    <input
                      ...
                      className="rounded border-slate-300 text-[#122B5A] focus:ring-[#122B5A] w-4 h-4"
                    />
            ...
            <div className="lg:col-span-4 bg-white border-2 border-[#FFB800] rounded-xl p-6 shadow-md space-y-6">
              
              <h2 className="text-xl font-extrabold text-[#122B5A] border-b border-slate-100 pb-3">
                Your order
              </h2>
                    ...
                    <>
                      ...
                      <div className="py-3 border-t border-b border-slate-200 space-y-2">
                        <div className="flex justify-between items-center text-slate-800">
                          ...
                          <span className="text-xs font-black text-[#122B5A]">৳{shippingFee.toFixed(2)}</span>
                        </div>
                        ...
                        <div className="space-y-1.5 pt-1">
                          <label 
                            ...
                            className={`flex items-center justify-between p-2 rounded-lg border text-xs cursor-pointer transition ${shippingMethod === "inside_dhaka" ? "bg-amber-50/80 border-[#FFB800] text-[#122B5A] font-bold" : "border-slate-200 text-slate-600 hover:bg-slate-50"}`}
                          >
                            ...
                            <span className="font-extrabold text-[#122B5A]">৳80.00</span>
                          </label>
                          ...
                          <label 
                            ...
                            className={`flex items-center justify-between p-2 rounded-lg border text-xs cursor-pointer transition ${shippingMethod === "outside_dhaka" ? "bg-amber-50/80 border-[#FFB800] text-[#122B5A] font-bold" : "border-slate-200 text-slate-600 hover:bg-slate-50"}`}
                          >
                            <div className="flex items-center gap-2">
                              <input
                                type="radio"
                            ...
                            <span className="font-extrabold text-[#122B5A]">৳120.00</span>
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="py-2 flex justify-between items-baseline text-slate-900 font-black">
                        ...
                        <span className="text-xl text-[#122B5A]">
                      ...
                      <div className="space-y-2 pt-3 border-t border-slate-200">
                        <div className="flex items-center gap-2.5 font-bold text-slate-800">
                          <span className="w-3.5 h-3.5 rounded-full border-4 border-[#122B5A] bg-white inline-block"></span>
                          <span>Cash on delivery</span>
                        </div>

                        <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-lg text-[11px] text-slate-600 leading-relaxed border-l-4 border-l-[#122B5A]">
                      ...
                      <button
                        ...
                        className="w-full bg-[#FFB800] hover:bg-[#E6A600] disabled:bg-slate-300 disabled:text-slate-500 disabled:cursor-not-allowed text-[#122B5A] font-extrabold text-sm py-3.5 px-6 rounded-full shadow-md transition duration-200 cursor-pointer text-center flex items-center justify-center gap-2 mt-4"
                      >
                        {isSubmitting ? (
                          <>
        ...
        <div className="mt-12 bg-white border border-slate-200 rounded-xl p-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-center text-xs font-bold text-slate-700">
          <div className="flex items-center justify-center gap-2">
            <ShieldCheck className="w-4 h-4 text-[#122B5A]" />
          ...
          <div className="flex items-center justify-center gap-2 border-t md:border-t-0 md:border-l border-slate-200 pt-3 md:pt-0">
            <Truck className="w-4 h-4 text-[#122B5A]" />
            <span>Non-contact shipping</span>
          </div>
          <div className="flex items-center justify-center gap-2 border-t md:border-t-0 md:border-l border-slate-200 pt-3 md:pt-0">
            <RotateCcw className="w-4 h-4 text-[#122B5A]" />
